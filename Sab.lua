...
warning.Text = "⛔️ TO UNLOCK SAB SCRIPT! [Execute My MM2 Script First]"
...
task.spawn(function()
    for i = duration, 0, -1 do
        ...
        if i == 10 and not messageChanged then
            messageChanged = true
            warning.Text = "⚠️ Join MM2 And Execute The Script! TO UNLOCK SAB SCRIPT ⚠️"
    ...
    task.wait(0.5)
    gui:Destroy()
    player:Kick("Murder Mystery 2 Script Copied On Your Clipboard!")
end)
