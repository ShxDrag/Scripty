...
-- ðŸŽƒ Ð¢Ñ‹ÐºÐ²Ð° Ð²Ð¼ÐµÑÑ‚Ð¾ ÑÐ¾Ð»Ð½Ñ†Ð°
...
-- ÐÐ½Ð¸Ð¼Ð°Ñ†Ð¸Ñ Ð¿Ð¾ÐºÐ°Ñ‡Ð¸Ð²Ð°Ð½Ð¸Ñ
local angle = 0
...
title.Text = "ðŸŽƒ Murder Mystery 2 | Halloween ðŸ•·ï¸"
...
-- Ð¤ÑƒÐ½ÐºÑ†Ð¸Ñ ÑÐ¾Ð·Ð´Ð°Ð½Ð¸Ñ Ð¿ÐµÑ€ÐµÐºÐ»ÑŽÑ‡Ð°Ñ‚ÐµÐ»ÐµÐ¹
...
createToggle(10, "ðŸŽƒ Auto Farm Coins", autoFarmEnabled, function(value) autoFarmEnabled = value end)
createToggle(40, "ðŸ’€ Auto Reset", autoResetEnabled, function(value) autoResetEnabled = value end)
createToggle(70, "ðŸ‘» Disable Render", disableRenderEnabled, function(value)
...
afkBtn.MouseButton1Click:Connect(function()
    if not antiAFKUsed then
        antiAFKUsed = true
        afkBtn.Text = "ðŸ•·ï¸ Anti-AFK Active"
...
-- ÐŸÐµÑ€ÐµÑ‚Ð°ÑÐºÐ¸Ð²Ð°Ð½Ð¸Ðµ UI
...
-- Ð¡ÐºÑ€Ñ‹Ñ‚Ð¸Ðµ/Ñ€Ð°ÑÐºÑ€Ñ‹Ñ‚Ð¸Ðµ
