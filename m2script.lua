...
createToggle(10, "🎃 Auto Farm Coins", autoFarmEnabled, function(value)
	autoFarmEnabled = value
end)

createToggle(40, "💀 Auto Reset", autoResetEnabled, function(value)
...
afkBtn.BackgroundColor3 = Color3.fromRGB(255, 120, 0)
